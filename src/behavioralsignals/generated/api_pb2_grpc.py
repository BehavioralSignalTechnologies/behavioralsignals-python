...
class BehavioralStreamingApiStub(object):
...
def add_BehavioralStreamingApiServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
        "behavioral_api.grpc.v1.BehavioralStreamingApi", rpc_method_handlers
    )
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers("behavioral_api.grpc.v1.BehavioralStreamingApi", rpc_method_handlers)


# This class is part of an EXPERIMENTAL API.
class BehavioralStreamingApi(object):
    """Missing associated documentation comment in .proto file."""
